...
public class MessageConstant {
    ...
    public static final String ADD_MEMBER_FAIL = "新增体检用户失败";
    public static final String ADD_MEMBER_SUCCESS = "新增体检用户成功";
    public static final String DELETE_MEMBER_FAIL = "删除体检用户失败";
    public static final String DELETE_MEMBER_SUCCESS = "删除体检用户成功";
    public static final String EDIT_MEMBER_FAIL = "编辑体检用户失败";
    public static final String EDIT_MEMBER_SUCCESS = "编辑体检用户成功";
    ...
    public static final String GET_MEMBER_NUMBER_REPORT_SUCCESS = "获取体检用户统计数据成功";
    public static final String GET_MEMBER_NUMBER_REPORT_FAIL = "获取体检用户统计数据失败";
